...
export default function PickPloggingFriendPage({navigation}: PickPloggingFriendscreenProps) {
  ...
  // 인덱스를 감소시키는 함수입니다.
  const goPrev = () => {
    setCurrentIndex((prevIndex) => (prevIndex - 1 + selectAnimalsArray.length) % selectAnimalsArray.length);
  };
    ...
    <ImageBackground
      ...
      <View style={styles.container}>
        <View style={styles.body1}>
          <FastImage style={styles.FriendDetail_Image} source={{uri: currentAnimal.fileUrl}}/>
          <AppText style={styles.animalName}>{currentAnimal.userAnimalName}</AppText>
          ...
          <View style={styles.bodyContainer1}>
            <View style={styles.active}>
              ...
              <View style={styles.Together}>
                <AppText style={styles.title2} >{currentAnimal.createTime}</AppText>
              </View>
            </View>
            <View style={styles.active}>
              <AppText style={styles.title} >같이 주운 쓰레기</AppText>
              <View style={styles.Together}>
                <AppText style={styles.title2}>{currentAnimal.trashTogether}개</AppText>
              </View>
            </View>
          </View>
          <View style={styles.bodyContainer1}>
            <View style={styles.active}>
              ...
              <View style={styles.Together}>
                <AppText style={styles.title2} >{currentAnimal.hour}시 {currentAnimal.minute}분{currentAnimal.second}초</AppText>
              </View>
            </View>
            <View style={styles.active}>
              <AppText style={styles.title} >함께 걸은 거리</AppText>
              <View style={styles.Together}>
                <AppText style={styles.title2}>{currentAnimal.lengthTogether}</AppText>
              </View>
            </View>
          </View>
        </View>
