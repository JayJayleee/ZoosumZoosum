...
export default function ItemListPage({navigation}: ItemListscreenProps) {
  ...
  const [variant1, setVariant1] = useState<'selectItem' | 'selectItem2'>(
    'selectItem',
  );
  const [variant2, setVariant2] = useState<'selectItem' | 'selectItem2'>(
    'selectItem2',
  );
    ...
    <ImageBackground
      ...
      <View style={styles.container}>
        <View style={styles.head}>
          <AppText style={styles.title_head}>내가 보유한 아이템</AppText>
        </View>
